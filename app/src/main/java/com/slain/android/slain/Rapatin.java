...
public class Rapatin extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private RecyclerView.Adapter adapter;
    private List<Rapat> listRapat;
    private SwipeRefreshLayout refreshLayout;
    ImageButton bookBtn, mineBtn;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rapatin);

        bookBtn = (ImageButton) findViewById(R.id.bookBtn);
        mineBtn = (ImageButton) findViewById(R.id.mineBtn);
        recyclerView = (RecyclerView) findViewById(R.id.recyclerViewRapatin);
        ...
        refreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            void refreshItems() {
                ...
                Intent i = new Intent(Rapatin.this, Rapatin.class);
                startActivity(i);
        ...
        bookBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Rapatin.this, FormBookingRapat.class);
                startActivity(i);
            }
        });
        mineBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Rapatin.this, RapatUser.class);
                startActivity(i);
            }
        });
    }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            RapatAdapter adapter = new RapatAdapter(Rapatin.this, listRapat);
